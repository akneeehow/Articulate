class Scene1 extends Phaser.Scene {
    ...
    preLoadEverything() {
        ...
        this.load.spritesheet("unoLogo", `${generatePath("spritesheets", "articulate.png")}`, {
            frameWidth: 419,
            frameHeight: 369
        });
        ...
        this.load.spritesheet("articulate", `${generatePath("spritesheets", "artic_game.jpeg")}`, {
            frameWidth: 57,
            frameHeight: 86
        });
