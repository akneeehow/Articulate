class Scene2 extends Phaser.Scene {
    ...
    * */
    ...
    create() {
        ...
        socket.addEventListener("message", function (e) {
            ...
            if(status === "start_game") {
                ...
                let username = data.username;
                if(username === me) {
                    let text = "You ARTICULATE Call failed!";
                    textToSpeech(text);
                }
            }
    ...
    getCardSprite(card, x, y, depth=0, scale=1) {
        ...
        let cardSprite = _this.physics.add.sprite(x, y, "articulate");
    ...
    createOrGetAnimationKey(card) {
        ...
        if (!currentAnimKeys.includes(animKey)) {
            ...
            this.anims.create({
                key: animKey,
                frames: _this.anims.generateFrameNumbers("articulate", {
                    start: imagePoint,
                    end: imagePoint
                }),
                frameRate: 0,
    ...
    setupGame() {
        ...
        // Adding Articulate Button and Unique Game ID
